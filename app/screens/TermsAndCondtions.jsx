    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        <Text style={{ fontSize: 15, fontWeight: "500" }}>
          ...
          related to it, still belong to Ashok. Traders Tunnel's owner is
          ...
          very clear to you exactly what you’re paying for. The Traders Tunnel
          app stores and processes personal data that you have provided to us,
          in order to provide my Service. It’s your responsibility to keep your
          ...
          security features and it could mean that the Traders Tunnel app won’t
          work properly or at all. The app does use third party services that
          declare their own Terms and Conditions. Link to Terms and Conditions
          of third party service providers used by the app Google Play Services
          AdMob You should be aware that there are certain things that owner
          ...
          can be Wi-Fi, or provided by your mobile network provider, but owner
          ...
          the same lines, owner cannot always take responsibility for the way
          ...
          the Service, owner cannot accept responsibility. With respect to
          owner's responsibility for your use of the app, when you’re using the
          ...
          available to you. owner accepts no liability for any loss, direct or
          ...
          app. The app is currently available on Android – the requirements for
          ...
          the updates if you want to keep using the app. owner does not promise
          that it will always update the app so that it is relevant to you
          and/or works with the Android version that you have installed on your
          ...
          from your device. Changes to This Terms and Conditions I may update
          our Terms and Conditions from time to time. Thus, you are advised to
          review this page periodically for any changes. I will notify you of
          any changes by posting the new Terms and Conditions on this page.
          These terms and conditions are effective as of 2021-11-05 Contact Us
          If you have any questions or suggestions about my Terms and
          Conditions, do not hesitate to contact me at
          traderstunnelinfo@gmail.com.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
