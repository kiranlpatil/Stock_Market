                ...
                <View style={styles.centralizedView}>
                    <View style={styles.authBox}>
                        ...
                        <View style={styles.inputBox}>
                            ...
                            <TextInput
                                style={{...styles.input, borderColor: isValidMail? '#dfe4ea' : 'red'}}
                                autoCapitalize={"none"}
                        ...
                        <View style={styles.inputBox}>
                            ...
                            <TextInput
                                style={{...styles.input, borderColor: isValidNumber? '#dfe4ea' : 'red'}}
                                value={mobile}
                        ...
                        <TouchableOpacity style={styles.loginButton} onPress={() => (isValidMail && isValidNumber) && Alert.alert('Login Success')}>
